...
class BackgroundSign extends AsyncTask<String, String, String> {
    Context cx;
    ProgressDialog progressDialog;

    public BackgroundSign(Context cx) {
        this.cx = cx;
    }
    ...
    protected void onPostExecute(String s) {
        ...
        if(s.equals("Thanks for Sign up!")){
            Toast.makeText(cx,"Data saved successfully!", Toast.LENGTH_LONG).show();
        }
