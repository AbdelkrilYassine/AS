...
public class DownloaderPhoto extends AsyncTask<Void,Void,String> {
    Context c;
    String urlAddess;
    GoogleMap map;
    public DownloaderPhoto(Context c, String urlAddess, GoogleMap map) {
        this.c = c;
    ...
    protected void onPostExecute(String jsonData) {
        ...
        {
            //PARSE
            new DataParserPhoto(c,jsonData,map).execute();
        }
    }
